...
# Create the users
puts "Creating users..."
asafsegev = User.create(name: "Asaf Segev", linkedin: "linkedin.com/asafsegev", career_goal: "Tech Entrepreneur", career_status: "MBA Candidate at Kellogg", advice_seeker: "1", mentor: "1", anonymous: "1", year_joined: "2005", num_followers: "234")
hannagutman = User.create(name: "Hanna Gutman", linkedin: "linkedin.com/hannagutman", career_goal: "Senior Project Manager", career_status: "Project Manager at Plumwise and TA at Kellogg", advice_seeker: "1", mentor: "1", anonymous: "0", year_joined: "2006", num_followers: "434")
sharonsegev = User.create(name: "Sharon Segev", linkedin: "linkedin.com/sharonsegev", career_goal: "Make my first exit", career_status: "CEO at the startup Alicanto", advice_seeker: "1", mentor: "1", anonymous: "1", year_joined: "2007", num_followers: "284")
shailabelletrop = User.create(name: "Shai Labelle Trop", linkedin: "linkedin.com/shailabelletrop", career_goal: "COO at a large chemical enterprise", career_status: "MBA Candidate at Kellogg", advice_seeker: "1", mentor: "1", anonymous: "0", year_joined: "2009", num_followers: "434")
johndre = User.create(name: "John Dre", linkedin: "linkedin.com/johndre", career_goal: "Work at Kraft", career_status: "Student at Princeton", advice_seeker: "1", mentor: "0", anonymous: "0", year_joined: "2014", num_followers: "234")
...
q2 = Question.create(user_id: hannagutman.id, q_text: "Should I switch to a FT position istead of 2 PT", q_date: "2009", num_likes: "134")
...
q5 = Question.create(user_id: johndre.id, q_text: "Should do an MBA?", q_date: "2015", num_likes: "64")
